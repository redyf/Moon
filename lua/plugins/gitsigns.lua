return {
	...
	vim.keymap.set("n", "<leader>ghp", "<cmd>Gitsigns preview_hunk<cr>", { silent = true, desc = "Preview Hunk" }),
	vim.keymap.set("n", "<leader>ghR", "<cmd>Gitsigns reset_buffer<cr>", { silent = true, desc = "Reset Buffer" }),
	vim.keymap.set({ "n", "v" }, "<leader>ghr", "<cmd>Gitsigns reset_hunk<cr>", { silent = true, desc = "Reset Hunk" }),
	vim.keymap.set(
		{ "n", "v" },
		"<leader>ghs",
